...
$(function(){$(".popup").magnificPopup({removalDelay:150,mainClass:"mfp-fade"}),$(document).ready(function(){$(".popup-youtube, .popup-vimeo, .popup-gmaps").magnificPopup({disableOn:700,type:"iframe",mainClass:"mfp-fade",removalDelay:160,preloader:!1,fixedContentPos:!1})}),$(function(){jcf.replaceAll()}),$(".header, .header-post").each(function(){var e=$(this).attr("data-image-src");void 0!==e&&!1!==e&&$(this).css("background","url("+e+") center bottom ")}),$("#click-prevent").click(function(e){e.preventDefault()}),$(window).scroll(function(){$(this).scrollTop()>50?$("#top-line__fixed").addClass("active"):$("#top-line__fixed").removeClass("active")}),$(window).scroll(function(){$(this).scrollTop()>50?$(".post-popup").addClass("active"):$(".post-popup").removeClass("active")}),$(".mobile-menu__open").click(function(){$(".stick").toggleClass(function(){return $(this).is(".open, .close")?"open close":"open"})}),$(".mobile-menu__open").click(function(){$(".top-line__wrapper").toggleClass("top-line__wrapper--bgt top-line__wrapper--bg")}),$(".mobile-menu__open").click(function(){"none"==$(".header-nav__list").css("display")?$(".mobile-menu__list").animate({height:"show"},300):$(".mobile-menu__list").animate({height:"hide"},300),"none"==$(".header-nav__button").css("display")?$(".header-nav__button").animate({height:"show"},300):$(".header-nav__button").animate({height:"hide"},300),$(".header-nav").toggleClass("offsetBottom")}),$(".carousel-top").owlCarousel({loop:!0,nav:!0,dots:!0,autoplay:!1,autoplayTimeout:5e3,navText:["",""],autoplayHoverPause:!0,smartSpeed:750,items:1}),$(".accordeon dd").hide().prev().click(function(){$(this).parents(".accordeon").find("dd").not(this).slideUp().prev().removeClass("active"),$(this).next().not(":visible").slideDown().prev().addClass("active")}),$(".accordeon dd").first().show()});